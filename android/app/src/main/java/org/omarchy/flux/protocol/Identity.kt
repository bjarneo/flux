...
val INCOMING = listOf(
    ...
    Types.SFTP, Types.FLUX_TUNNEL, Types.FLUX_WEBCAM, Types.FLUX_APPROVE,
)
...
val OUTGOING = listOf(
    ...
    Types.MPRIS_REQUEST, Types.SFTP_REQUEST, Types.FLUX_TUNNEL, Types.FLUX_WEBCAM, Types.FLUX_APPROVE,
)
